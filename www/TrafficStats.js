 ...
 */
  ...
  TrafficStats.prototype.getDestroy = function(successCallback, errorCallback){
    argscheck.checkArgs('fF','TrafficStats.getDestroy', arguments);
    exec(successCallback, errorCallback, "TrafficStats", "getDestroy", []);
  };
